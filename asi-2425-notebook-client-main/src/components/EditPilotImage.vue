<template>
    <div class="edit-circuit-container">
      <h2>Editar Imagen del Piloto</h2>
      <form @submit.prevent="submitForm">
        <div class="form-group">
          <label for="circuitName">Nombre del Piloto:</label>
          <input type="text" id="circuitName" :value="pilotId" readonly />
        </div>
        <div class="form-group">
  ...
  export default {
    ...
    methods: {
      submitForm() {
        console.log(`Guardando imagen para el circuito: ${this.circuitId}`);
