<template>
  <div class="edit-circuit-container">
    <h2>Gestionando Imagen del Circuito: {{ this.circuito.nombre }}</h2>

    
    <div class="columns">
      <!-- Columna para Editar Imagen -->
      <div class="column" v-if="this.circuito.tieneImagen">
        <h3>Editar Imagen</h3>
...
export default {
  ...
  async mounted() {
    ...
    this.circuito = await CircuitRepository.findById(this.circuitoId);
  },
  methods: {
    editImage() {
